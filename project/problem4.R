...
for (i in units){
   ...
   corInUnit <- mean(t)
   corOutUnit <- mean(f)
   printf("mean corralation to week %d quiz: %d", i, t)
   printf("mean corralation to other quizs: %d", f)
   printf("the diffence of corralation: %d", t)
